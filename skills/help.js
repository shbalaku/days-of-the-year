...
module.exports = function (controller) {
    ...
    controller.hears('help', 'direct_message,direct_mention', function (bot, message) {
        ...
        text += "\n- " + bot.appendMention(message, "<dd>/<mm>") + ": ask for list of events on _dd/mm_";
        text += "\n- " + bot.appendMention(message, "when is <day>") + ": ask when a certain day is";
        text += "\n- " + bot.appendMention(message, "remind <day>") + ": ask to remind you of a certain day";
        text += "\n\nI also understand:";
